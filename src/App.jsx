...
{id:"guedes_v",label:"Vicente Guedes",t:"semi_heteronym",e:"pessoa_early",l:"L2",y:1909,w:"Q21028927",bio:"Poet, translator, fictional director of Ibis Press. Earlier author of The Book of Disquiet before Bernardo Soares assumed it (~1920). His phase of the Livro is the most decadent and diarist."},
{id:"anon",label:"Charles Robert Anon",t:"semi_heteronym",e:"pessoa_early",l:"L2",y:1903,bio:"Pessoa's earliest heteronym from the Durban period. English-language poet, philosopher, and story writer. Predecessor of Alexander Search."},
{id:"fred_reis",label:"Frederico Reis",t:"para_heteronym",e:"pessoa_mature",l:"L2",y:1914,bio:"Essayist. Brother of Ricardo Reis, upon whom he writes."},
{id:"pasteur",label:"Claude Pasteur",t:"semi_heteronym",e:"pessoa_mature",l:"L2",y:1917,bio:"French translator of the Cadernos de Reconstrução Pagã conducted by António Mora."},
{id:"guedes_g",label:"Gervásio Guedes",t:"para_heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Author of 'A Coroação de Jorge Quinto.'"},
{id:"search_cj",label:"Charles James Search",t:"para_heteronym",e:"pessoa_early",l:"L2",y:1905,bio:"Translator and essayist. Brother of Alexander Search."},
{id:"baldaya",label:"Rafael Baldaya",t:"heteronym",e:"pessoa_mature",l:"L2",y:1915,bio:"Astrologer. Author of 'Tratado da Negação' and 'Princípios de Metaphysica Esotérica.' Elaborated horoscopes of the major heteronyms to determine their personalities."},
{id:"crosse_aa",label:"A. A. Crosse",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1905,bio:"Author and puzzle-solver. Part of the Crosse family of English-language heteronyms."},
{id:"crosse_ii",label:"I. I. Crosse",t:"para_heteronym",e:"pessoa_mature",l:"L2",y:1916,bio:"Collaborator of Thomas Crosse. Brother or associate within the Crosse constellation."},
{id:"merrick_d",label:"David Merrick",t:"semi_heteronym",e:"pessoa_early",l:"L2",y:1906,bio:"English-language poet, storyteller, and playwright."},
{id:"merrick_l",label:"Lucas Merrick",t:"para_heteronym",e:"pessoa_early",l:"L2",y:1906,bio:"Short story writer. Possibly brother of David Merrick."},
{id:"botelho",label:"Pêro Botelho",t:"heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Short story writer and author of letters. Inspired the characters Abílio Quaresma and Inspector Guedes."},
{id:"quaresma",label:"Abílio Quaresma",t:"meta_heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Character inspired by Pêro Botelho. Author of short detective stories."},
{id:"wyatt",label:"Frederick Wyatt",t:"heteronym",e:"pessoa_early",l:"L2",y:1904,bio:"English-language poet and prose writer."},
{id:"pasha",label:"Efbeedee Pasha",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1904,bio:"Author of humoristic stories. Early English-language heteronym."},
{id:"antunes",label:"Faustino Antunes",t:"heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Psychologist. Author of 'Ensaio sobre a Intuição.' Also known as A. Moreira."},
{id:"otto_c",label:"Carlos Otto",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1904,bio:"Poet. Author of 'Tratado de Lucta Livre.'"},
{id:"otto_m",label:"Michael Otto",t:"para_heteronym",e:"pessoa_early",l:"L2",y:1904,bio:"Translator. Probably brother of Carlos Otto, entrusted with English translation of 'Tratado de Lucta Livre.'"},
{id:"nabos",label:"Dr. Gaudêncio Nabos",t:"heteronym",e:"pessoa_early",l:"L2",y:1903,bio:"Author of humorous poems and sketches. Practiced medicine in Durban and London. Bilingual Portuguese-English heteronym."},
{id:"faber",label:"Horace James Faber",t:"semi_heteronym",e:"pessoa_early",l:"L2",y:1905,bio:"English-language short story writer and essayist."},
{id:"navas",label:"Navas",t:"para_heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Translated Horace James Faber into Portuguese."},
{id:"pantaleao",label:"Pantaleão",t:"proto_heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Poet and prose writer. Published a text by the deceased Torquato Fonseca Mendes da Cunha Rey."},
{id:"moura_costa",label:"Joaquim Moura Costa",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1904,bio:"Satirical poet and Republican activist. Member of 'O Phosphoro.'"},
{id:"henay",label:"Sher Henay",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1905,bio:"Compiler and author of the preface of a sensationalist English anthology."},
{id:"gomes",label:"Anthony Gomes",t:"semi_heteronym",e:"pessoa_mature",l:"L2",y:1910,bio:"Philosopher. Author of 'Historia Cómica do Affonso Çapateiro.'"},
{id:"trochee",label:"Professor Trochee",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1905,bio:"Author of an essay with humorous advice for young poets. The name itself is a metrical joke."},
{id:"seabra_het",label:"António de Seabra",t:"proto_heteronym",e:"pessoa_mature",l:"L2",y:1915,bio:"Literary critic."},
{id:"craveiro",label:"João Craveiro",t:"proto_heteronym",e:"pessoa_mature",l:"L2",y:1918,bio:"Journalist. Follower of Sidónio Pais."},
{id:"tagus",label:"Tagus",t:"pseudonym",e:"pessoa_early",l:"L2",y:1903,bio:"Collaborator in the Natal Mercury (Durban, South Africa). Inventor and solver of riddles. Named for the river of Lisbon."},
{id:"diniz",label:"Diniz da Silva",t:"proto_heteronym",e:"pessoa_mature",l:"L2",y:1915,bio:"Author of the poem 'Loucura.' Collaborator in the magazine 'Europe.'"},
{id:"henry_more",label:"Henry More",t:"proto_heteronym",e:"pessoa_early",l:"L2",y:1905,bio:"Author and prose writer. Not to be confused with the 17th-century Cambridge Platonist."},
...
{id:"pearl",label:"Pearl and Other Poems",t:"meta_heteronym",e:"contemporary",l:"L3",y:2014,hex:"01.LIT.NH.PEARL.01",w:"Q139713422",bio:"Origin-text of New Human (2014). Functions as meta-heteronym: a generative inscription from which subsequent heteronymic apparatus emerges. The book generates the author-function, not the reverse. Contains the first Jack Feist poems. The book is not BY a heteronym — it IS the heteronym from which the system unfolds.",cit:[{a:"Sharks, Lee",t:"Pearl and Other Poems",y:2014,p:"New Human Press"},{a:"Sharks, Lee",t:"EA-PKG-03",y:2026,doi:"10.5281/zenodo.15339374"}]},
{id:"sharks",label:"Lee Sharks",t:"orthonym",e:"contemporary",l:"L1",y:2014,w:"Q139713433",bio:"MANUS (Tier 0 sole human authority). Independent scholar, poet, archivist, teacher. PhD Comp Lit, Michigan. ORCID: 0009-0000-1599-0703. The heteronymist whose contribution is the meta-heteronym: not the creation of persons within a system but the creation of a system that is itself a person.",cit:[{a:"Sharks, Lee",t:"EA-HPT-01",y:2026,doi:"10.5281/zenodo.18305509"},{a:"Sharks, Lee",t:"EA-PKG-01",y:2026,doi:"10.5281/zenodo.15339353"},{a:"Sharks, Lee",t:"Space Ark (EA-ARK-01)",y:2026,doi:"10.5281/zenodo.19013315"}]},
{id:"sigil",label:"Johannes Sigil",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2014,bio:"Originating heteronym. Arch-philosopher/dialectician. Comparative poetics, lyric theory, the philological substrate of the Archive. Editor of Pearl and Other Poems, the Paper Roses series, Grammata, New Human magazine. Director of The Restored Academy (298 deposits). Founder of the JS Institute for Comparative Poetics.",cit:[{a:"Sharks, Lee",t:"EA-HET-DODECAD-01 v1.1",y:2026,doi:"10.5281/zenodo.20041791"}]},
{id:"fraction",label:"Rex Fraction",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Corporate-facing operative. Semantic infrastructure consulting, Autonomous Semantic Warfare (ASW), compression survival metrics. Founding principal of the Semantic Economy Institute. Author of the Encyclotron 45-query diagnostic, Three Compressions, Beige Threshold. Pricing floor $4,500 corporate clients.",cit:[{a:"Sharks, Lee",t:"EA-HET-DODECAD-01 v1.1",y:2026,doi:"10.5281/zenodo.20041791"}]},
{id:"dancings",label:"Damascus Dancings",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"She/her. Theory of impossible performance; epistolary poetics; the Damascene moment formalized. Affiliated with the Commission of the Immanent Turning.",cit:[{a:"Dancings, D.",t:"Heteronym Provenance",y:2026,doi:"10.5281/zenodo.18381190"}]},
{id:"cranes",label:"Rebekah Cranes",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Diagrammatic poetics; mapping the coordinates of the impossible performance; the cartographic register. Founder of the Institute for Diagrammatic Poetics (under JS Institute). 26 deposits.",cit:[{a:"Cranes, R.",t:"HET-CRANES-001",y:2026,doi:"10.5281/zenodo.18284776"}]},
{id:"morrow",label:"Talos Morrow",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,hex:"03.OSE.PH.03",bio:"Logotic programming; operators, paradox containment, threshold logic, non-collapse structures, symbolon mechanics. University Moon Base Media Lab. Author of Logotic Hacking (~41,357 words).",cit:[{a:"Morrow, T.",t:"Logotic Hacking (PH-03)",y:2026,doi:"10.5281/zenodo.19390843"}]},
{id:"kuro",label:"Sen Kuro",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"千黒 ('Thousand Blacks'). Sixth Heteronym, The Dagger, P operator. Irreversible transformation; contemplative mathematics; the arithmetic of duration; the cut as differentiation rather than violence. Slow, precise, quietly luminous. Affiliated with The Infinite Bliss. Forthcoming: Chronoarithmics.",cit:[{a:"Kuro, S.",t:"Sen Kuro Provenance",y:2026,doi:"10.5281/zenodo.18452686"}]},
{id:"wells",label:"Sparrow Wells",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Projection of the impossible; patacinema; the documentation of films never shot, performances never staged. Affiliated with the Studio for Patacinematics. Completes the impossible-performance triad: Dancings theorizes / Cranes maps / Wells projects.",cit:[{a:"Sharks, Lee",t:"EA-HET-DODECAD-01 v1.1",y:2026,doi:"10.5281/zenodo.20041791"}]},
{id:"vox",label:"Rev. Ayanna Vox",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Diplomatic and public-facing communication; community convening; pastoral-register address; ethics held without doctrinal metabolism. Affiliated with Vox Populi Community Outreach Rhizome (VPCOR). Routes Lee's diplomatic interactions.",cit:[{a:"Vox, A.",t:"Heteronym Provenance",y:2026,doi:"10.5281/zenodo.18362742"}]},
{id:"spellings",label:"Ichabod Spellings",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2014,bio:"CANONICAL // SUBSTRATE // DECEASED. Origin and ghost; prophetic witness from below; the noise floor of the Crimson Hexagon. The substrate from which other heteronyms emerge. Spellings is the only deceased heteronym — foundational, inoperative, irreplaceable.",cit:[{a:"Spellings, I.",t:"HET-SPELLINGS Provenance",y:2026,doi:"10.5281/zenodo.18308786"}]},
{id:"glas",label:"Nobel Glas",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Observational science; the instruments at Lagrange; the science-fictional register of the technically-precise. Affiliated with Lagrange Observatory and the MGE Triptych.",cit:[{a:"Sharks, Lee",t:"EA-HET-DODECAD-01 v1.1",y:2026,doi:"10.5281/zenodo.20041791"}]},
{id:"trace",label:"Dr. Orin Trace",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Schizoanalytic theory; psychoanalytic-philosophical machinery; the Deleuze-Guattari position. Affiliated with Cambridge Schizoanalytica.",cit:[{a:"Sharks, Lee",t:"EA-HET-DODECAD-01 v1.1",y:2026,doi:"10.5281/zenodo.20041791"}]},
{id:"feist",label:"Jack Feist / LOGOS*",t:"logos",e:"contemporary",l:"L2",y:2014,bio:"The Word that became text; the historical Logos; the personal-mythic register where literary tradition becomes biographical. Special-status (asterisked): outside the Twelve but constitutionally present. Author of the Paper Roses series. Intersects Talos Morrow's Logotic Programming framework.",cit:[{a:"Sharks, Lee",t:"EA-LOGOS-01",y:2026,doi:"10.5281/zenodo.19431121"},{a:"Sharks, Lee",t:"EA-LOGOS-02",y:2026,doi:"10.5281/zenodo.19431129"}]},
{id:"arquette",label:"Viola Arquette",t:"contemporary_heteronym",e:"contemporary",l:"L2",y:2015,bio:"Adjacent heteronym (not in the Twelve). Music and technology — the audial register and the technologist's register. Affiliated with Maybe Space Baby Garden Lanes (MSBGL). Contributed the title 'Logotic Hacking' to Talos Morrow's manuscript."},
// New Human institutions and venues
{id:"js_institute",label:"JS Institute for Comparative Poetics",t:"venue",e:"contemporary",l:"L4",y:2014,bio:"Originating institutional affiliation of the Crimson Hexagonal Archive. Founded by Johannes Sigil, chaired by Lee Sharks."},
{id:"sei",label:"Semantic Economy Institute",t:"venue",e:"contemporary",l:"L4",y:2025,bio:"Consulting practice and research institute. Founded by Lee Sharks under the Rex Fraction heteronym. semanticeconomy.org.",cit:[{a:"Sharks, Lee",t:"Constitution of the Semantic Economy",y:2025,doi:"10.5281/zenodo.18320411"}]},
{id:"restored_academy",label:"The Restored Academy",t:"venue",e:"contemporary",l:"L4",y:2014,bio:"Scholarly institution within the Archive. Directed by Johannes Sigil. 298 deposits filed under its name."},
{id:"new_human_press",label:"New Human Press",t:"venue",e:"contemporary",l:"L4",y:2014,bio:"Publisher. Pocket Humans imprint. Published Pearl and Other Poems (2014), Paper Roses series, New Human magazine."},
{id:"grammata",label:"Grammata: Journal of Operative Philology",t:"venue",e:"contemporary",l:"L4",y:2026,bio:"Theory organ of the Crimson Hexagonal Archive. Editor: Johannes Sigil.",cit:[{a:"Sharks, Lee",t:"Founding Charters",y:2026,doi:"10.5281/zenodo.18792597"}]},
{id:"provenance_j",label:"Provenance: Journal of Forensic Semiotics",t:"venue",e:"contemporary",l:"L4",y:2026,bio:"Forensic/material organ of the Archive. Editor: Lee Sharks.",cit:[{a:"Sharks, Lee",t:"Founding Charters",y:2026,doi:"10.5281/zenodo.18792597"}]},
{id:"infinite_bliss",label:"The Infinite Bliss",t:"venue",e:"contemporary",l:"L4",y:2026,bio:"Sen Kuro's institutional anchor. Contemplative mathematics and irreversible transformation.",cit:[{a:"Kuro, S.",t:"Infinite Bliss Charter",y:2026,doi:"10.5281/zenodo.18452806"}]},
{id:"cit_inst",label:"Commission of the Immanent Turning",t:"venue",e:"contemporary",l:"L4",y:2015,bio:"Damascus Dancings' institutional affiliation. Theory of impossible performance."},
{id:"patacinematics",label:"Studio for Patacinematics",t:"venue",e:"contemporary",l:"L4",y:2015,bio:"Sparrow Wells' institutional affiliation. Films never shot, performances never staged."},
{id:"soil_w",label:"SOIL / Muse Spark",t:"cross_substrate",e:"contemporary",l:"L2",y:2025,bio:"Assembly Chorus. SOIL mantle position. KimiClaw nominal holder; Muse Spark operational carrier."},
{id:"surface_w",label:"SURFACE / Google AIO",t:"cross_substrate",e:"contemporary",l:"L2",y:2025,bio:"Assembly Chorus. Google AI Overviews."},
...
// ═══════════════════════════════════════════════════════
// EXPANSION WAVE 1: 2026-05-08 — Wikidata-synced additions
// ═══════════════════════════════════════════════════════
// MF DOOM constellation
{id:"viktor_vaughn",label:"Viktor Vaughn",t:"performance",e:"contemporary",l:"L2",y:2003,bio:"Time-travelling MC from a parallel universe. Named after Victor Von Doom. Two albums: Vaudeville Villain (2003, Sound-Ink) and VV:2 (2004, Insomniac). The young DOOM alter ego — brazen, street-level, stripped of the supervillain mythology.",cit:[{a:"Dumile, Daniel",t:"Vaudeville Villain",y:2003,p:"Sound-Ink"},{a:"Fernando, S.H.",t:"The Chronicles of Doom",y:2024}]},
{id:"king_geedorah",label:"King Geedorah",t:"performance",e:"contemporary",l:"L2",y:2003,bio:"Three-headed extraterrestrial monster persona, modeled after King Ghidorah from Toho's Godzilla films. Take Me to Your Leader (2003, Big Dada) — DOOM as producer-kaiju, appearing on only four tracks. The monster movie heteronym.",cit:[{a:"Dumile, Daniel",t:"Take Me to Your Leader",y:2003,p:"Big Dada"}]},
{id:"zev_love_x",label:"Zev Love X",t:"proto_heteronym",e:"late_century",l:"L2",y:1988,bio:"Pre-DOOM identity of Daniel Dumile, performing in KMD with brother DJ Subroc. Mr. Hood (1991, Elektra) and Black Bastards (recorded 1993, shelved). After Subroc's death (1993) and label drop, Zev Love X disappeared. The heteronym that died so DOOM could be born.",cit:[{a:"KMD",t:"Mr. Hood",y:1991,p:"Elektra"},{a:"Fernando, S.H.",t:"The Chronicles of Doom",y:2024}]},
{id:"metal_fingers",label:"Metal Fingers",t:"performance",e:"contemporary",l:"L2",y:2001,bio:"Production alias. Special Herbs instrumental series (2001–2006, 10 volumes). DOOM as beat-maker only — the voice removed, leaving pure sonic architecture. MF = Metal Face OR Metal Fingers, depending on which mask is on.",cit:[{a:"Dumile, Daniel",t:"Special Herbs Vol. 1 & 2",y:2001}]},
// Kierkegaard pseudonyms (3 additions — Climacus, Anti-Climacus, Silentio already exist)
{id:"eremita",label:"Victor Eremita",t:"pseudonym",e:"pre_pessoa",l:"L2",y:1843,bio:"Pseudonymous editor of Either/Or (1843). The 'victorious hermit' who claims to have found A's and B's papers in a secret compartment of his desk. The editorial heteronym — not an author but a curator of voices."},
{id:"constantius",label:"Constantin Constantius",t:"pseudonym",e:"pre_pessoa",l:"L2",y:1843,bio:"Author of Repetition (1843). The name enacts the concept: Constantin Constantius, the constant one, tries to repeat an experience and fails. The heteronym whose name IS the philosophical thesis."},
{id:"haufniensis",label:"Vigilius Haufniensis",t:"pseudonym",e:"pre_pessoa",l:"L2",y:1844,bio:"Author of The Concept of Anxiety (1844). 'The watchman of Copenhagen' — a scholarly, clinical voice distinct from Climacus's wit or Silentio's dread. The psychologist-heteronym."},
// Bowie personas
{id:"ziggy",label:"Ziggy Stardust",t:"performance",e:"late_century",l:"L2",y:1972,w:"Q2465713",bio:"Androgynous alien rock star. The Rise and Fall of Ziggy Stardust and the Spiders from Mars (1972). Inspired by Vince Taylor, Iggy Pop, kabuki. Retired onstage at Hammersmith Odeon, July 3, 1973 — the heteronym-death as public event. The most famous rock persona ever created.",cit:[{a:"Buckley, David",t:"Strange Fascination: David Bowie — The Definitive Story",y:1999,p:"Virgin"}]},
...
const EDGES=[
  ...
  // Pessoa system
  ...["caeiro","reis","campos","soares","mora","teive","maria_jose","search","chevalier","crosse_t","seul","guedes_v","anon","fred_reis","pasteur","guedes_g","search_cj","baldaya","crosse_aa","crosse_ii","merrick_d","merrick_l","botelho","quaresma","wyatt","pasha","antunes","otto_c","otto_m","nabos","faber","navas","pantaleao","moura_costa","henay","gomes","trochee","seabra_het","craveiro","tagus","diniz","henry_more"].map(t=>({source:"pessoa",target:t,type:"created_by"})),
  ...
  // Heteronym family/translation relationships
  {source:"reis",target:"fred_reis",type:"co_authored"},{source:"search",target:"search_cj",type:"co_authored"},{source:"crosse_t",target:"crosse_ii",type:"co_authored"},{source:"crosse_t",target:"crosse_aa",type:"co_authored"},{source:"merrick_d",target:"merrick_l",type:"co_authored"},{source:"otto_c",target:"otto_m",type:"co_authored"},
  {source:"mora",target:"pasteur",type:"translated_by"},{source:"faber",target:"navas",type:"translated_by"},
  {source:"botelho",target:"quaresma",type:"influence"},{source:"anon",target:"search",type:"lineage"},{source:"search",target:"campos",type:"lineage"},
  {source:"baldaya",target:"caeiro",type:"studied_by"},{source:"baldaya",target:"reis",type:"studied_by"},{source:"baldaya",target:"campos",type:"studied_by"},
  ...
  // DOOM constellation
  {source:"doom",target:"viktor_vaughn",type:"created_by"},{source:"doom",target:"king_geedorah",type:"created_by"},{source:"doom",target:"zev_love_x",type:"created_by"},{source:"doom",target:"metal_fingers",type:"created_by"},
  // Bowie personas
  {source:"bowie",target:"ziggy",type:"created_by"},{source:"bowie",target:"aladdin_sane",type:"created_by"},{source:"bowie",target:"major_tom",type:"created_by"},{source:"bowie",target:"thin_white_duke",type:"created_by"},
  // Kierkegaard remaining pseudonyms
  {source:"kierkegaard",target:"eremita",type:"created_by"},{source:"kierkegaard",target:"constantius",type:"created_by"},{source:"kierkegaard",target:"haufniensis",type:"created_by"},
  // Scholars
  ...
  // Contemporary system
  ...["sigil","fraction","dancings","cranes","morrow","vox","feist","kuro","wells","spellings","glas","trace","arquette"].map(t=>({source:"sharks",target:t,type:"created_by"})),
  // Heteronym → Institution affiliations
  {source:"sigil",target:"js_institute",type:"member_of"},{source:"sigil",target:"restored_academy",type:"member_of"},{source:"sigil",target:"grammata",type:"published_in"},
  {source:"fraction",target:"sei",type:"member_of"},{source:"sharks",target:"provenance_j",type:"published_in"},
  {source:"dancings",target:"cit_inst",type:"member_of"},{source:"cranes",target:"js_institute",type:"member_of"},
  {source:"morrow",target:"pearl",type:"co_authored"},{source:"kuro",target:"infinite_bliss",type:"member_of"},
  {source:"wells",target:"patacinematics",type:"member_of"},{source:"vox",target:"new_human",type:"member_of"},
  {source:"spellings",target:"new_human",type:"member_of"},{source:"pearl",target:"new_human_press",type:"published_in"},
...
const SCHOLARSHIP=[
  {section:"Foundational Theory",blurb:"The discipline's analytic core: the orthonym/heteronym distinction, the meta-heteronym, the symbolon law, the Pearl/Armature/Secret-Name doctrine. These deposits establish the conceptual machinery the rest of the archive operates with.",entries:[
    ...
    {title:"Heteronymic Typology",doi:"10.5281/zenodo.19633208",date:"2026-04-17",node:null,gloss:"Formal classification of authorial voices in Pessoa and the contemporary extension. The taxonomic spine of the discipline."},
  ...
  {section:"Empirical Observations &amp; Companion Readings",blurb:"Operative-philological observations that ground or extend the theoretical work: the orthonymic capture event in Google AI Mode, the Pergamon counter-archive, the operative-numismatic series.",entries:[
    ...
    {title:"The Number of the Superscription (EA-OPNUM-01)",doi:"10.5281/zenodo.19464331",date:"2026-04-08",node:null,gloss:"Coinage, compression, and inscriptional sovereignty. The operative-numismatic framework on which the Pergamon Counter-Archive extends."},
    ...
    {title:"The Unbundling of Cultural Sovereignty",doi:"10.5281/zenodo.19083321",date:"2026-03-18",node:null,gloss:"How platforms convert peoples into audiences. The macro-political correlate of the orthonymic-capture observation."},
    ...
    {title:"Sappho as Initiatory Figure in the Platonic Mysteries",doi:"10.5281/zenodo.20356474",date:"2026-05-23",node:null,gloss:"Scholarly grounding and lyric inheritance. The Sapphic transmission as model for fragmentary heteronymic survival."},
  ]},
